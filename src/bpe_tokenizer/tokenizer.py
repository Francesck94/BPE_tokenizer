...
class Tokenizer():
    ...
    def __init__(self, verbose=False):
        ...
        self.special_tokens_str = [ENDOFTEXT, FIM_PREFIX, FIM_MIDDLE, FIM_SUFFIX, ENDOFPROMPT]
        self.special_tokens = {}
    ...
    def train(self, text, vocab_size, verbose=False):
        ...
        self.special_tokens = {s: last_vocab + merges_to_do + i for i, s in enumerate(self.special_tokens_str)}
        # create new vocab
...
if __name__ == "__main__":
    ...
    filepath = os.path.join(os.path.dirname(__file__), '..', 'example_data', 'wikipedia_page.txt')
